  ...
  return (
    <React.Fragment>
      <div id="surveyCompleted">
        ...
        <p>You may also return to the AI Playbook questionnaire to explore and revise your options.
          Once you are done, you may download a pdf version of the latest report.</p><br />
